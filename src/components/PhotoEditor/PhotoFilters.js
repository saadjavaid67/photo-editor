...
const PhotoFilters = ({ file, setFile, filterHandler, imgData }) => {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < (imgData.width * imgData.height); i++) {
            ...
            data[offset + 0] = (filters.negative == 1 ? -1 : 1) * parseInt(filters.contrast) * (((filters.bw == 0) ? (imgData.data[offset + 0]) : (parseInt(((imgData.data[offset + 0]+ imgData.data[offset + 1] + imgData.data[offset + 2])/3) < (filters.bw * 2.55) ? 0 : 255))) ^ parseFloat(filters.power)) + parseInt(filters.brightness) + parseInt(filters.red) + (filters.negative == 1 ? 255 : 0); // Red channel
            data[offset + 1] = (filters.negative == 1 ? -1 : 1) * parseInt(filters.contrast) * (((filters.bw == 0) ? (imgData.data[offset + 1]) : (parseInt(((imgData.data[offset + 0]+ imgData.data[offset + 1] + imgData.data[offset + 2])/3) < (filters.bw * 2.55) ? 0 : 255))) ^ parseFloat(filters.power)) + parseInt(filters.brightness) + parseInt(filters.green) + (filters.negative == 1 ? 255 : 0); // Green channel
            data[offset + 2] = (filters.negative == 1 ? -1 : 1) * parseInt(filters.contrast) * (((filters.bw == 0) ? (imgData.data[offset + 2]) : (parseInt(((imgData.data[offset + 0]+ imgData.data[offset + 1] + imgData.data[offset + 2])/3) < (filters.bw * 2.55) ? 0 : 255))) ^ parseFloat(filters.power)) + parseInt(filters.brightness) + parseInt(filters.blue) + (filters.negative == 1 ? 255 : 0); // Blue channel
